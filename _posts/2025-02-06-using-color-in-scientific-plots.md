...
Most off-the-shelf palettes, like Tableau, Seaborn, or ColorBrewer, come with around ten colours. For many projects, that’s plenty. My personal favourite is Seaborn’s default palette, called “deep,” which looks professional and generally offers enough contrast to separate categories. If you have trouble distinguishing some of the hues, or if you’re concerned about colour blindness, Seaborn’s “colorblind” palette is a great alternative.

But what if you have more than 10 categories? That’s when something like “husl” (in seaborn) can save the day by evenly slicing the hue circle into as many colours as you need.
...
A common example is ColorBrewer’s **“Blues”** palette, which moves from a pale, almost-white blue to a deep navy. This type of palette is my usual go-to for continuous data, but it comes with a couple of potential pitfalls. First, the darkest shade tends to draw the most attention, which can be misleading if those values aren’t actually the most significant. Second, very light shades may blend into a white background, making it hard to distinguish lower values.

To avoid these issues, you might try a “perceptually uniform” palette, which adds in a bit of hue variation so you don’t have to rely purely on lightness changes. One well-known option is **“viridis”**, though I’ve found that it doesn’t always complement my data visually. Instead, I often use Seaborn’s default **“ch:s=-.2,r=.6”** palette, which is a happy medium between a standard sequential scheme and a fully perceptually uniform approach.If you prefer slightly less variation in lightness, ‘flare’ and ‘crest’ are also excellent options.
